...
class UnetGenerator(nn.Module):
    ...
    def forward(self,input):
        ...
        down_4 = self.down_4(pool_3)#8
        pool_4 = self.pool_4(down_4)
        down_5 = self.down_5(pool_4)#8
        ...
        concat_1 = torch.cat([trans_1,down_5],dim=1)#16
...
test_dataset = MyDataset(test_X_files,test_Y_files,transform=aug)
